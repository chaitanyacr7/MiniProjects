    ...
    function validate() {
        ...
        storeData.push(lastName);
        storeData.push(gender);
        storeData.push(otherDetail);
        alert("Thank You!");
        return true;
    }
    ...
    function viewTable() {
        if (storeData.length > 1) {
            ...
            data1.append(storeData[0]);
            data2.append(storeData[1]);
            data3.append(storeData[2]);
            data4.append(storeData[3]);
        } else {
